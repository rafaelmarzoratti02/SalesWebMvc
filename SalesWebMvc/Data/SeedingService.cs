...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Alex Grey", "grey@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s3 = new Seller(3, "Martha Red", "martha@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s4 = new Seller(4, "Donald Blue", "donald@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s5 = new Seller(5, "Alex Pink", "alex@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s6 = new Seller(6, "Maria Green", "alex@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
